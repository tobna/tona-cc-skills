...
% \todo is defined near the draft-mode block at the end of this file
...
% Rebuttal reviewer tags: bold, distinctly colored R1..R4 to signpost which reviewer a point answers
...
% \todo: always-visible red box, works with or without draft mode (as before) — strip todos before submitting
\newcommand{\todo}[1]{\colorbox{red}{TODO: #1}}

% --- Draft-mode aids: line numbers, label keys, overfull bars ---
...
\ifdefined\ifdraftmode\else \newif\ifdraftmode \fi   % default: off if the main file didn't set it
\ifdraftmode
